...
Expressão regular ou *regex* é 
uma sequência concisa de caracteres que
representa várias strings.
Entender o básico de expressões regulares é 
indispensável para trabalhar com textos.
...
```{r echo=FALSE}
decisoes_min <- ifelse(str_length(decisoes) > 47, 
                       paste0(str_sub(decisoes, 1, 47), '...'), 
                       decisoes)
```
